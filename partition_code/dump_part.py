...
def improved_partition_graph(g, num_parts, sample_length, out_path, reshuffle, node_part_var, graph_name = 'test',balance_ntypes=None, balance_edges=False, num_hops=1, return_mapping=True):
    #partitions = []
    #partition_sets = []
