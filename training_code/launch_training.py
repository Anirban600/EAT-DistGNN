...
def submit_jobs(args, udf_command, dry_run=False):
    ...
    # launch server tasks
    print(hosts, server_count_per_machine)
    if not has_alive_servers(args):
        ...
        for i in range(len(hosts) * server_count_per_machine):
            ...
            cmd = "source /etc/profile.d/modules.sh; module load anaconda3; conda activate envforgnn; module load codes/gpu/cuda/11.6; cd " + \
