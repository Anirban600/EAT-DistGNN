...
class EarlyStopping:
    def __init__(self, num_machines, patience=15, model_save_path=''):
    ...
    def step(self, acc_l, phase, model, acc_g=None):
        if phase == 0:
            ...
            if self.best_score_g is None:
                ...
                self.counter += 1
                print(
                    f'EarlyStopping counter: {self.counter} out of {self.patience} got {score} while best is {self.best_score_g}')
